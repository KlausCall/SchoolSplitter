...
const HelpDialog: React.FC<Props> = () => (
  <div >
    <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#helpModalScrollable">
      Hilfe
    </button>

    <div className="modal fade" id="helpModalScrollable" role="dialog" aria-labelledby="helpModalScrollableTitle" aria-hidden="true">
      <div className="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="helpModalScrollableTitle">Hilfe</h5>
